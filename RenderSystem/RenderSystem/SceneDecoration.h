...
namespace RenderSystem
{
  struct SceneDecoration
  {
    ...
    static SceneDecoration createDecoration(
      const Ray& ray, float length, const Material& material
    );
    static SceneDecoration createDecoration(
      const Line& line, bool withArrowHead, const Material& material
    );
    static SceneDecoration createDecoration(
      const Plane& plane, float width, float length, const Material& material
    );
