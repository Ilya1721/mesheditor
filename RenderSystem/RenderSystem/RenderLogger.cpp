...
namespace
{
  ...
  std::string getShaderOrProgramInfoLog(
    GetShaderIV getShaderIVFunc, GetShaderInfoLog getShaderInfoLogFunc, int shaderId
  )
  {
    int infoLogLength = 0;
...
namespace RenderSystem
{
  ...
  {
    auto getShaderIVFunc =
      shaderType == SHADER_TYPE::SHADER ? glGetShaderiv : glGetProgramiv;
