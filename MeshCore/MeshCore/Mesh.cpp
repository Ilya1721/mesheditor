...
namespace MeshCore
{
	...
	MeshIntersectionData Mesh::findIntersection(const Ray& ray, bool intersectSurface, int passedFacesCount) const
	{
		...
		{
			meshIntersectionData.interestedFacesIndices = std::vector<int>{ faceIdx + passedFacesCount };
		}
